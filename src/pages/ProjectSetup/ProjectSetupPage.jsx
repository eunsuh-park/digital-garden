/**
 * ProjectSetup page entry file.
 * Handles the initial project setup flow, including basic info and the first map builder step.
 */
...
} from '@/pages/ProjectSetup/lib/projectSetup';
import { createProject } from '@/shared/api/projectsApi';
import { PROJECT_SPACE_SIZE_MAP_BUILDER_TAB_ITEMS } from '@/shared/lib/projectSpace';
...
import './styles/ProjectSetupPage.css';
