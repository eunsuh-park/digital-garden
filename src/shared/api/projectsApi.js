/**
 * Shared projects API helpers.
 * Wraps Supabase CRUD used across setup flows and project providers.
 */
...
/**
 * 프로젝트 생성
 * @param {{ name: string, space_size: string, space_description?: string, owner_id?: string }} project
 * @returns {Promise<{ data, error }>}
 */
